...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    public static String fecha,horqdeentrada,horasalida,profesorr,laboratorio,alumnos="";
 ...
 private boolean jj=true;
    ...
    private void initView() {
        ...
        buttonregistro=(ImageView)findViewById(R.id.guardar);
    ...
    public void handleDecode(Result result) {
        ...
        if (null == result) {
            mDecodeManager.showCouldNotReadQrCodeFromScanner(this, new DecodeManager.OnRefreshCameraListener() {
             ...
             resultStringgg = result.getText();

            handleResult(resultStringgg);
        }
    ...
    private void registrarr(){
            CrearBD crearBD=new CrearBD(QrCodeActivity.this,"bd_clases",null,1);
            SQLiteDatabase sqLiteDatabase=crearBD.getWritableDatabase();
            sqLiteDatabase.execSQL("INSERT INTO clasess (profesor,alumnoinfo,laboratorio,fecha,horaentrada,horasalida)VALUES('"+profesorr+"','"+alumnos+"','"+laboratorio+"','"+fecha+"','"+horqdeentrada+"','"+horasalida+"')");
            Toast.makeText(QrCodeActivity.this, "Se ha registrado", Toast.LENGTH_SHORT).show();
        /*try {
